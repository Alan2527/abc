...
<body class="body1">
    ...
    <a class="btn btn-primary btn-enviar btn4 btn-crearcomu btn-crearcomu3" href="formulario-seguridad.php"><strong>Crear Nuevo Comunicado</strong></a>
</header>

<div class="tit-comu"><h1 class="titulo-comu"><strong>Seguridad e Higiene</strong></h1></div>
...
<div class="card card7 border-info mb-3" style="max-width: 25rem; min-width: 25rem; padding: 5px !important; ">
  ...
  <div class="botones7">
  <a class="btn btn-primary btn-enviar btn4 btn42" href="editar-comu-seguridad.php?id=<?php echo $row['id']; ?>"> Editar</a>
  <a class="btn btn-danger btn-enviar btn4 btn42" href="eliminar-seguridad.php?id=<?php echo $row['id']; ?>">Eliminar</a>
</div>
</div>
