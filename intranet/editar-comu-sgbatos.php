...
<body>
    ...
    <a class="btn btn-danger btn-enviar btn4 btn-crearcomu btn-crearcomu2" href="cargas-sgbatos.php"><strong>Volver</strong></a>
...
<?php
$id=$_GET['id'];
$sql="SELECT * FROM comusgbatos WHERE id='$id' ORDER BY id DESC";
$result=mysqli_query($conexion, $sql);

while($row=mysqli_fetch_array($result)){
    ?>
<form action="procesar-comu-sgbatos.php" method="POST">
